                                ...
                                {activeOrders.map(order => (
                                    ...
                                    >
                                        <View style={styles.cardHeader}>
                                            ...
                                            <Text style={styles.restaurantName}>{order.restaurantId?.name || 'Mirchi Restaurant'}</Text>
                                ...
                                pastOrders.map(order => (
                                    ...
                                    >
                                        <View style={styles.pastLeft}>
                                            ...
                                            <View>
                                                <Text style={styles.pastName}>{order.restaurantId?.name || 'Restaurant'}</Text>
                                                <Text style={styles.pastMeta}>{new Date(order.createdAt).toLocaleDateString()} • ₹{order.totalAmount}</Text>
                                            </View>
                                        </View>
...
const styles = StyleSheet.create({
    ...
    activeCard: { backgroundColor: '#fff', borderRadius: 20, padding: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3, marginBottom: 15 },
    cardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    restaurantName: { fontSize: 16, fontWeight: '700', color: '#1A1A1A', marginLeft: 10, flex: 1 },
    ...
    pastCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', padding: 15, borderRadius: 15, marginBottom: 10 },
    pastLeft: { flexDirection: 'row', alignItems: 'center' },
    pastIconCircle: { width: 35, height: 35, borderRadius: 18, backgroundColor: '#F0F0F0', justifyContent: 'center', alignItems: 'center', marginRight: 15 },
